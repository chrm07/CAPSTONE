                ...
                <TableRow key={app.id} className="hover:bg-slate-50 transition-colors border-slate-100">
                  ...
                  <TableCell>
                    <div className="flex flex-col">
                       <span className="font-bold text-slate-700 text-xs truncate max-w-[150px]">{app.school}</span>
                       <span className="text-[10px] font-bold text-slate-400 uppercase truncate max-w-[150px]">{app.course}</span>
                    </div>
                  </TableCell>
