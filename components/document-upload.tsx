                      ...
                      <div className="flex items-center justify-between">
                        ...
                        >
                          ...
                          <div className="min-w-0">
                            <p className="text-sm font-medium truncate group-hover:underline decoration-dashed underline-offset-4">{docStatus.fileName}</p>
                            <p className="text-xs text-muted-foreground font-medium flex gap-1">
        ...
        <DialogContent className="max-w-5xl w-[95vw] h-[90vh] p-0 rounded-3xl overflow-hidden flex flex-col border-0 shadow-2xl bg-slate-900 z-[100] [&>button]:hidden">
          <DialogHeader className="p-4 bg-white shrink-0 flex flex-row items-center justify-between border-b border-slate-200">
            <div className="flex-1 min-w-0 pr-4 text-left">
              <DialogTitle className="text-lg font-black uppercase tracking-tight text-slate-800 truncate">{previewDoc?.fileName}</DialogTitle>
