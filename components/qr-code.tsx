  ...
  useEffect(() => {
    const generateQRCode = async () => {
      try {
        ...
        // Create VERY simple QR data - just the student ID prefixed with BTS:
        // This creates a much cleaner QR code that's easy to scan
        const qrValue = `BTS:${studentId}`
        
        console.log("[v0] QR Code generating with value:", qrValue)
