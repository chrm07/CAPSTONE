                    ...
                    <div className="space-y-5">
                      <div className="flex items-start gap-3 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <p className="text-xs sm:text-sm font-bold text-slate-800 mt-1 truncate" title={app.school}>{app.school || "N/A"}</p>
                          <p className="text-[11px] sm:text-xs font-medium text-slate-500 mt-0.5 truncate" title={app.course}>{app.course || "N/A"} • Year {app.yearLevel || "N/A"}</p>
                        </div>
                      </div>
