                  ...
                  <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 flex-1 flex flex-col">
                    ...
                    <div className="flex items-center gap-4 sm:gap-5 p-4 sm:p-5 bg-slate-50 border border-slate-100 rounded-3xl relative shrink-0">
                      ...
                      <div className="flex-1 min-w-0">
                        <h3 className="font-black text-slate-800 text-base sm:text-lg uppercase tracking-tight truncate">{verificationResult.student?.name}</h3>
                        <p className="text-[10px] sm:text-xs font-bold text-slate-500 tracking-wider truncate mt-0.5">ID: {verificationResult.student?.id}</p>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-y-4 gap-x-4 text-sm bg-white p-4 sm:p-6 rounded-3xl border border-slate-100 shadow-sm flex-1">
                      <div className="col-span-2">
                        ...
                        <p className="text-xs sm:text-sm font-bold text-slate-800 truncate">{verificationResult.student?.course}</p>
                        <p className="text-[10px] sm:text-xs font-medium text-slate-500 mt-0.5 truncate">Year {verificationResult.student?.yearLevel}</p>
                      </div>
                      <div className="col-span-2">
