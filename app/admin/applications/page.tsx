        ...
        <AdminLayout>
                            ...
                            <Card key={idx} className="rounded-3xl border-slate-200 shadow-sm overflow-hidden flex flex-col bg-white">
                              <div className="p-3 flex items-center gap-3 border-b border-slate-100 bg-slate-50/50">
                                ...
                                <div className="flex-1 min-w-0">
                                  <p className="text-xs font-bold text-slate-800 leading-tight truncate" title={reqName}>{reqName}</p>
          ...
          <Dialog open={isRejectDialogOpen} onOpenChange={setIsRejectDialogOpen}>
             <DialogContent className="rounded-3xl p-6 sm:max-w-md bg-white border-0 shadow-2xl">
               ...
               <div className="py-4">
                 <textarea
                   className="w-full min-h-[120px] p-4 border border-slate-200 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none resize-none text-sm font-medium shadow-sm transition-all"
            ...
            <DialogContent className="max-w-5xl w-[95vw] h-[90vh] p-0 rounded-3xl overflow-hidden flex flex-col border-0 shadow-2xl bg-slate-900 z-[100] [&>button]:hidden">
              <DialogHeader className="p-4 bg-white shrink-0 flex flex-row items-center justify-between border-b border-slate-200">
                <div className="flex-1 min-w-0 pr-4">
                  <DialogTitle className="text-lg font-black uppercase tracking-tight text-slate-800 truncate">
                    {previewDoc?.name}
                  </DialogTitle>
